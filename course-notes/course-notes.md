...
| |
| |
Load CSS --> Parse CSS --> -------------------------- --> CSS Object Model----| - resolve conflicting CSS declarations | - Process final CSS |
|
...
4. Block-level
5. inline-block
6. Positioning Schemes: ![positioning schemes](./positioning-schemes.png)
7. normal flow
